...
void printStats(int livello, int score, Par pacman, double deltaTime, int highscore[], int scoreTotale, int uccisioni){
    ...
    //stampo tempo
    mvprintw(5, 132, "%.3f", deltaTime);
    //stampo vite
    mvprintw(6, 132, "%d", pacman.vite);
    //stampo salute
    mvprintw(7, 132, "%d", 10-pacman.colpiSubiti);
    //stampo uccisioni
    mvprintw(8, 132, "%d", uccisioni);
    //bonus tempo
    mvprintw(9, 124, "Bonus tempo: %.3f", ((score+scoreTotale)/deltaTime)*175);
}
...
int gameController(int livello, Buffer *dati, _Bool *collisioni, int highscore[]){
    ...
    int numPallini[3] = {NUM_PALLINI_1, NUM_PALLINI_2, NUM_PALLINI_3};
    int maxScore[3] = {2100, 1900, 1920};
    int frutto;
    _Bool flagFrutta;
    int pallini[3][210][3]= {{
        ...
        {13, 91, 0}, {13, 94, 0}, {13, 108, 0}, {16, 42, 0}, {16, 56, 0}, {16, 66, 0}, {16, 84, 0}, 
        {16, 94, 0}, {16, 108, 0}, {19, 42, 0}, {19, 45, 0}, {19, 49, 0}, {19, 53, 0}, {19, 56, 0}, 
        {19, 59, 0}, {19, 63, 0}, {19, 66, 0}, {19, 70, 0}, {19, 80, 0}, {19, 84, 0}, {19, 88, 0}, 
        {19, 91, 0}, {19, 94, 0}, {19, 97, 0}, {19, 101, 0}, {19, 105, 0}, {19, 108, 0}, {22, 56, 0}, 
        {22, 70, 0}, {22, 80, 0}, {25, 56, 0}, {25, 65, 0}, {25, 68, 0}, {25, 71, 0}, {25, 75, 0}, 
        {25, 79, 0}, {25, 82, 0}, {25, 85, 0}, {28, 56, 0}, {28, 65, 0}, {28, 85, 0}, {30, 56, 0}, 
        {30, 61, 0}, {30, 65, 0}, {30, 85, 0}, {30, 89, 0}, {30, 94, 0}, {32, 65, 0}, {32, 85, 0}, 
        {32, 94, 0}, {35, 65, 0}, {35, 68, 0}, {35, 71, 0}, {35, 75, 0}, {35, 79, 0}, {35, 82, 0}, 
        {35, 85, 0}, {35, 94, 0}, {39, 42, 0}, {39, 45, 0}, {39, 48, 0}, {39, 52, 0}, {39, 56, 0}, 
        {39, 60, 0}, {39, 64, 0}, {39, 67, 0}, {39, 70, 0}, {39, 75, 0}, {39, 80, 0}, {39, 83, 0}, 
        {39, 86, 0}, {39, 90, 0}, {39, 94, 0}, {39, 98, 0}, {39, 102, 0}, {39, 105, 0}, {39, 108, 0}, 
        {42, 42, 0}, {42, 56, 0}, {42, 70, 0}, {42, 75, 0}, {42, 80, 0}, {42, 94, 0}, {42, 108, 0}, 
        {45, 42, 4}, {45, 45, 0}, {45, 49, 0}, {45, 56, 0}, {45, 60, 0}, {45, 64, 0}, {45, 67, 0}, 
        {45, 70, 0}, {45, 75, 0}, {45, 80, 0}, {45, 83, 0}, {45, 86, 0}, {45, 90, 0}, {45, 94, 0}, 
        {45, 101, 0}, {45, 105, 0}, {45, 108, 4}, {48, 49, 0}, {48, 56, 0}, {48, 64, 0}, {48, 70, 0}, 
        {48, 75, 0}, {48, 80, 0}, {48, 86, 0}, {48, 94, 0}, {48, 101, 0}, {51, 42, 0}, {51, 45, 0}, 
        {51, 49, 0}, {51, 52, 0}, {51, 56, 0}, {51, 64, 0}, {51, 67, 0}, {51, 70, 0}, {51, 75, 0}, 
        {51, 80, 0}, {51, 83, 0}, {51, 86, 0}, {51, 94, 0}, {51, 97, 0}, {51, 101, 0}, {51, 105, 0}, 
        {51, 108, 0}, {53, 42, 0}, {53, 70, 0}, {53, 75, 0}, {53, 80, 0}, {53, 108, 0}, {55, 42, 0}, 
        {55, 45, 0}, {55, 48, 0}, {55, 51, 0}, {55, 54, 0}, {55, 57, 0}, {55, 60, 0}, {55, 63, 0}, 
        {55, 66, 0}, {55, 70, 0}, {55, 73, 0}, {55, 77, 0}, {55, 80, 0}, {55, 84, 0}, {55, 87, 0}, 
    ...
    while(livello<3 && flagVittoria) {
        ...
        while(personaggi[PACMAN].vite > 0 && scorePallini < maxScore[livello]) {
                ...
                if(entita.entita < NUM_PERSONAGGI && entita.sparo) {
                    if(canShoot(proiettili, entita.entita)) {
                        if(bulletMv(entita.x+1, entita.y, SU, livello)) {
                            ...
                            clockProiettili[entita.entita][SU-SHIFT_MOVIMENTO] = clock();
                        ...
                        if(bulletMv(entita.x+1, entita.y+2, GIU, livello)) {
                            ...
                            clockProiettili[entita.entita][GIU-SHIFT_MOVIMENTO] = clock();
                        ...
                        if(bulletMv(entita.x+2, entita.y+1, DESTRA, livello)) {
                            ...
                            clockProiettili[entita.entita][DESTRA-SHIFT_MOVIMENTO] = clock();
                        ...
                        if(bulletMv(entita.x, entita.y+1, SINISTRA, livello)) {
                            ...
                            clockProiettili[entita.entita][SINISTRA-SHIFT_MOVIMENTO] = clock();
            ...
            printStats(livello, scoreLivello, personaggi[PACMAN], deltaTime, highscore, scoreTotale, scoreFantasmi);

            for(int i=0; i<NUM_PERSONAGGI; i++) {
                for(int j=0; j<MAX_PROIETTILI; j++) {
                    if(proiettili[i][j].sparo) {
                        deltaTime = ((double) (end-clockProiettili[i][j]))/CLOCKS_PER_SEC;
                        if(deltaTime > 6) {
                            for (int i=0; i<60; i++){
                                for(int j=0; j<152; j++){
                                    if(Campo[livello][i][j] == '#' && (j> 2 && j< 145)){
                                        attron(COLOR_PAIR(4));
                                        mvprintw(i,j, "%c", Campo[livello][i][j]);
                                        attroff(COLOR_PAIR(4));
                                    }
                                }
                            }
                            ...
                            proiettili[i][j].sparo = false;
                            mvprintw(proiettili[i][j].y, proiettili[i][j].x, " ");
